...
func (tq *ThemeQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (tq *ThemeQuery) FirstIDX(ctx context.Context) int {
...
func (tq *ThemeQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (tq *ThemeQuery) OnlyIDX(ctx context.Context) int {
...
func (tq *ThemeQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (tq *ThemeQuery) IDsX(ctx context.Context) []int {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tgb *ThemeGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: ThemeGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *ThemeGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *ThemeGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: ThemeGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *ThemeGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *ThemeGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: ThemeGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *ThemeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *ThemeGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: ThemeGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *ThemeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *ThemeSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: ThemeSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *ThemeSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *ThemeSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: ThemeSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *ThemeSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *ThemeSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: ThemeSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *ThemeSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *ThemeSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: ThemeSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *ThemeSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{theme.Label}
	default:
		err = fmt.Errorf("ent: ThemeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
